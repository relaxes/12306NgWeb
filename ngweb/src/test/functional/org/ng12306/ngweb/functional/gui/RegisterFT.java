package org.ng12306.ngweb.functional.gui;

import static org.junit.Assert.*;

import org.junit.Test;
import org.openqa.selenium.By;
import org.ng12306.ngweb.functional.BaseSeleniumTestCase;
...
public class RegisterFT extends BaseSeleniumTestCase {
	...
	public void register() {
		...
		//跳转到登录页
		assertEquals("NgWeb示例:登录页", s.getTitle());
		...
		//登陆成功
		assertEquals("NgWeb示例:任务管理", s.getTitle());
